...
// Desktop uses the same stacked-surface cover grammar as the homepage: read a
// full section, then the next surface rides up and covers it. Touch/tablet
// layouts remain normal flow so forms and service rows stay stable.
